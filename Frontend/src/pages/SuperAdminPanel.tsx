  ...
  return (
    <div className="p-4 md:p-8 bg-gray-50 min-h-screen">
      <h1 className="text-3xl font-bold mb-10 text-center text-gray-800 relative">
        <span className="relative z-10">Super Admin Booking Management</span>
        <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-32 h-1 bg-[#6A5631] rounded-full"></span>
      </h1>
