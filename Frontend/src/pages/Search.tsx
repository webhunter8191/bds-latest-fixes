...
//   return (
//     <div className="py-0 container mx-auto max-w-screen-xl lg:px-0 mx-0 px-3 sm:px-6 lg:px-0">
//       <div className="mb-6 ">
//         <SearchBar />
//       </div>
    ...
    <div className="py-0 container mx-auto max-w-screen-xl lg:px-0 mx-0 px-3 sm:px-6 lg:px-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-4">
        ...
        <div className="lg:block">
          ...
          >
            <div className="space-y-2">
              <h3 className="text-xl sm:text-2xl md:text-lg font-semibold text-gray-800 border-b pb-4">
                Filter by:
              </h3>
              <StarRatingFilter
                selectedStars={selectedStars}
